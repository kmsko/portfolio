...
const Page4 = (props) => {
    return <div className={style.wrapper}>
        ...
        <ul className={style.description}>
            <li>Развивающийся forot-end разработчик</li>
            <li>Проходил курсы в&nbsp;онлайн школе geekbrains в&nbsp;направление Front-end</li>
            <li>Изучил HTML 5, CSS 3, JS&nbsp;ES6, React JS </li>
            <li>Знаю базовые вещи о&nbsp;препроцессорах SASS LESS</li>
            <li>Каждый день совершенствуюсь и&nbsp;изучаю для себя новые технологии</li>
